...
double GetISR2011MR(const FourVector P1, const FourVector P2, const FourVector ME, int Assumption, const FourVector ISR)
{
   if(Assumption == 1)
   {
      FourVector ME1 = ME;
   ...
   if(Assumption == 6)
   {
      ...
      FourVector P16 = P1Temp6.Boost(-Total6, fabs(Beta6));
      FourVector P26 = P2Temp6.Boost(-Total6, fabs(Beta6));
...
double GetISR2011R(const FourVector P1, const FourVector P2, const FourVector ME, int Assumption, const FourVector ISR, char AdditionalVariant)
{
   if(Assumption == 1)
   {
      FourVector ME1 = ME;
