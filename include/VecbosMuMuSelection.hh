...
#ifndef VecbosMuMuSelection_h
#define VecbosMuMuSelection_h
...
class VecbosMuMuSelection : public Vecbos {
public:
  
  //! constructor
  VecbosMuMuSelection(TTree *tree=0);
  //! destructor
  virtual ~VecbosMuMuSelection();
  //! loop over events
  void Loop();
